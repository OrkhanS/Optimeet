# Generated by Django 2.2.8 on 2020-04-16 12:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hasMatchedToday', models.BooleanField(default=False, verbose_name='Has user matched today')),
                ('email', models.CharField(max_length=200, unique=True, verbose_name='Username')),
                ...
                ('language1', models.CharField(max_length=255, verbose_name='First Language')),
                ('language2', models.CharField(blank=True, default='false', max_length=255, verbose_name='Second Language')),
                ('wantstoMatch', models.BooleanField(default=False, verbose_name='does user want to Match someone?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('userAccess', models.BooleanField(default=True, verbose_name='Can user Access to Room')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.CharField(max_length=2000, verbose_name='contentofPost')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('lang', models.CharField(max_length=255, verbose_name='language')),
                ('ownerPost', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='post', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Pictures',
